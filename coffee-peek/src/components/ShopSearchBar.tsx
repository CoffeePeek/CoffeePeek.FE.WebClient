  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="hidden lg:block pt-6 pb-4">
        ...
        <h1 style={{ margin: '0 0 16px', fontFamily: '"Inter"', fontWeight: 700, fontSize: 26, lineHeight: 1.1, letterSpacing: '-0.02em', color: dark ? '#fff' : '#1C1917', textAlign: 'center' }}>
          Кофейни рядом
        </h1>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <input
            ...
            style={{ width: '100%', height: 40, borderRadius: 10, border: `1px solid ${inputBorder}`, background: inputBg, padding: '0 14px 0 40px', fontSize: 14, fontFamily: '"Inter"', color: dark ? '#fff' : '#1C1917', outline: 'none', boxSizing: 'border-box' as const }}
          />
        </div>
      </div>
      ...
      <div className="lg:hidden pt-5 pb-3">
        <h1 style={{ margin: 0, fontFamily: '"Inter"', fontWeight: 700, fontSize: 20, letterSpacing: '-0.02em', color: dark ? '#fff' : '#1C1917' }}>
          Кофейни рядом
        </h1>
      </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
          ...
          <div style={{ flex: '1 1 0', minWidth: 0, position: 'relative' }}>
            ...
            <input
              ...
              style={{ width: '100%', height: 44, borderRadius: 10, border: `1px solid ${inputBorder}`, background: colors.surface, padding: '0 14px 0 40px', fontSize: 14, fontFamily: '"Inter"', color: dark ? '#fff' : '#1C1917', outline: 'none', boxSizing: 'border-box' as const, minWidth: 0 }}
            />
          </div>
          ...
          <button type="button" onClick={onFilterToggle} style={{ ...filterBtn(44), background: showFilters ? gold : colors.surface }}>
            ...
            <span>Фильтры</span>
            {activeFilterCount > 0 && (
              <span style={{ minWidth: 18, height: 18, borderRadius: 99, background: showFilters ? '#1A1412' : gold, color: showFilters ? gold : '#1A1412', fontFamily: '"Inter"', fontWeight: 700, fontSize: 10, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '0 5px' }}>
                {activeFilterCount}
              </span>
            )}
          </button>
