...
RF Dewiface CoffeeShopListProps {
  ...
  return (
    <>
      <div className="min-h-screen pb-20" style={{ backgroundColor: colors.background, position: 'relative' }}>
        {/* Dotted bg pattern */}
        {isDark && (
          <div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(#2D241F 1px, transparent 1px)', backgroundSize: '40px 40px', opacity: 0.5, poRF DewiEvents: 'none', zIndex: 0 }} />
        )}
                      ...
                      {featured.map(shop => {
                        ...
                        return (
                          <div key={`f-${shop.id}`} onClick={() => openShopDetails(shop.id)}
                            style={{ flexShrink: 0, width: 200, borderRadius: 14, overflow: 'hidden', border: `1px solid ${colors.border}`, background: colors.surface, cursor: 'poRF Dewi' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                      <button
                        ...
                        style={{
                          ...
                          fontFamily: '"RF Dewi Expanded"', fontSize: 12, fontWeight: 600, cursor: 'poRF Dewi',
                        }}
                      >
                              ...
                              return (
                                <button
                                  ...
                                  style={{
                                    ...
                                    cursor: 'poRF Dewi', textAlign: 'left',
                                  }}
                                >
                                  {option.label}
      ...
      {showFilters && (
        <div className="lg:hidden fixed inset-0 z-50">
          <button
            ...
            className="absolute inset-0 bg-black/50 border-0 cursor-poRF Dewi"
