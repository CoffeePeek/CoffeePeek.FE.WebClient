      ...
      <div style={{ width: '100%', maxWidth: 460, margin: '0 auto', padding: 16, position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ padding: 40, paddingTop: sent ? 40 : 48, borderRadius: 24, background: 'rgba(45,36,31,0.6)', backdropFilter: 'blur(24px)', border: `1px solid ${cardBorder}`, boxShadow: '0 24px 48px -12px rgba(0,0,0,0.5)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 28 }}>
            ...
            <span style={{ fontFamily: '"Manrope",system-ui', fontWeight: 700, letterSpacing: '-0.025em', fontSize: 18, color: textPrimary }}>
          ...
          {sent ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <Link
                to="/login"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, width: '100%', height: 48, borderRadius: 12, background: gold, color: '#1A1412', fontFamily: '"Manrope"', fontWeight: 600, fontSize: 15, textDecoration: 'none' }}
              >
                Вернуться ко входу
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p style={{ margin: '0 0 24px', fontFamily: '"Manrope", sans-serif', fontSize: 14, color: textMuted, textAlign: 'center', lineHeight: 1.55 }}>
                Укажите email — пришлём ссылку для сброса, если аккаунт найден.
              </p>

              <label style={{ display: 'block', textAlign: 'left', marginBottom: 16 }}>
                <div style={{ fontFamily: '"Manrope", sans-serif', fontSize: 12, fontWeight: 600, color: textMuted, marginBottom: 6 }}>Email</div>
                <input
                  type="email"
                  value={email}
              ...
              <p style={{ margin: '20px 0 0', textAlign: 'center', fontFamily: '"Manrope", sans-serif', fontSize: 13, color: textMuted }}>
