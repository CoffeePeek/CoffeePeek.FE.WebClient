    ...
    return (
      <div style={{ minHeight: '100dvh', background: '#1A1412', display: 'grid', placeItems: 'center', padding: 16 }}>
        <div style={{ maxWidth: 460, width: '100%', padding: 40, borderRadius: 24, background: 'rgba(45,36,31,0.6)', border: `1px solid ${cardBorder}`, textAlign: 'center' }}>
          ...
          <h1 style={{ margin: '0 0 10px', fontFamily: '"Manrope"', fontWeight: 700, fontSize: 24, color: textPrimary }}>Ссылка недействительна</h1>
          <p style={{ margin: '0 0 24px', fontFamily: '"Manrope", sans-serif', fontSize: 14, color: textMuted }}>В ссылке нет токена сброса пароля.</p>
        ...
        <div style={{ padding: 40, paddingTop: done ? 40 : 48, borderRadius: 24, background: 'rgba(45,36,31,0.6)', backdropFilter: 'blur(24px)', border: `1px solid ${cardBorder}` }}>
          ...
          {done ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <h1 style={{ margin: '0 0 10px', fontFamily: '"Manrope"', fontWeight: 700, fontSize: 24, color: textPrimary }}>Пароль обновлён</h1>
              <p style={{ margin: '0 0 24px', fontFamily: '"Manrope", sans-serif', fontSize: 14, color: textMuted, lineHeight: 1.55 }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p style={{ margin: '0 0 24px', fontFamily: '"Manrope", sans-serif', fontSize: 14, color: textMuted, textAlign: 'center' }}>
                Придумайте новый пароль для входа
              </p>

              <label style={{ display: 'block', marginBottom: 14 }}>
                <div style={{ fontFamily: '"Manrope", sans-serif', fontSize: 12, fontWeight: 600, color: textMuted, marginBottom: 6 }}>Новый пароль</div>
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    style={{
                      ...
                      fontFamily: '"Manrope", sans-serif', fontSize: 15, outline: 'none', boxSizing: 'border-box',
                    }}
                  />
                  <button
                    type="button"
              ...
              <label style={{ display: 'block', marginBottom: 16 }}>
                <div style={{ fontFamily: '"Manrope", sans-serif', fontSize: 12, fontWeight: 600, color: textMuted, marginBottom: 6 }}>Повторите пароль</div>
                <input
                  type={showPwd ? 'text' : 'password'}
              ...
              {error && (
                <p style={{ margin: '0 0 12px', fontFamily: '"Manrope", sans-serif', fontSize: 13, color: '#EF4444' }}>{error}</p>
              )}
