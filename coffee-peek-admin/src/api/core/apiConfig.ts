...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    CATALOG_CITY_BY_ID: (id: string) => `/api/admin/cities/${id}`,
    CATALOG_BEANS: '/api/admin/beans',
    CATALOG_BEAN_BY_ID: (id: string) => `/api/admin/beans/${id}`,
    CATALOG_EQUIPMENTS: '/api/admin/equipments',
    CATALOG_EQUIPMENT_BY_ID: (id: string) => `/api/admin/equipments/${id}`,
    ...
    CATALOG_BREW_METHOD_BY_ID: (id: string) => `/api/admin/brew-methods/${id}`,
